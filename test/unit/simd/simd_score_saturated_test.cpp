...
struct saturated_add_test : public ::testing::Test
{
...
TYPED_TEST_SUITE(saturated_add_test, testing_types);

TYPED_TEST(saturated_add_test, above_simd)
{
...
TYPED_TEST(saturated_add_test, above_scalar)
{
    using simd_score_t = typename TestFixture::simd_score_t;
    using scalar_t = typename TestFixture::scalar_t;
...
TYPED_TEST(saturated_add_test, below_simd)
{
    using simd_score_t = typename TestFixture::simd_score_t;
    using scalar_t = typename TestFixture::scalar_t;
...
TYPED_TEST(saturated_add_test, below_scalar)
{
    using simd_score_t = typename TestFixture::simd_score_t;
    using scalar_t = typename TestFixture::scalar_t;
