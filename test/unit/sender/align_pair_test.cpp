...
#include <pairwise_aligner/sender/align_with.hpp>
#include <pairwise_aligner/sender/align.hpp>
...
TEST(basic_sender_test, align_pair)
{
    ...
    // align_pair() -> creates a sender of this object,
    // does not generate a value yet.
    //
    auto s = unifex::just(seq1, seq2) | aligner::align_with(aligner_config) | aligner::align;
