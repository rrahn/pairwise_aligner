...
INSTANTIATE_TYPED_TEST_SUITE_P(global_standard_affine_fixed_simd_equal_size_test,
                               pairwise_aligner_test,
                               global::standard::affine::fixed_simd::equal_size_types,);

INSTANTIATE_TYPED_TEST_SUITE_P(global_standard_affine_fixed_simd_variable_size_test,
                               pairwise_aligner_test,
