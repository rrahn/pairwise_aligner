...
namespace global::semi_second::affine::scalar {
...
inline constexpr auto base_config =
    aligner::cfg::method_global(
        ...
        aligner::cfg::leading_end_gap{.first_row = aligner::cfg::end_gap::free },
        aligner::cfg::trailing_end_gap{.last_row = aligner::cfg::end_gap::free }
    );
...
DEFINE_TEST_VALUES(infix_match,
    ...
    .sequence1 = "ACGTAAAACGT"sv,
    .sequence2 = "TTTTTACGTATGTCCCCC"sv,
    .expected_score = 10
)

DEFINE_TEST_VALUES(prefix_match,
    .configurator = aligner::cfg::score_model_unitary(base_config, 4, -5),
    .sequence1 = "ACGAGGCTAC"sv,
    .sequence2 = "AAGACTACGGGGGG"sv,
    .expected_score = 11
)
...
INSTANTIATE_TYPED_TEST_SUITE_P(test,
                               test_suite,
                               global::semi_second::affine::scalar::test_types,);
