...
# This file adds version support for `find_package(PAIRWISE_ALIGNER 3.1)`.
...
find_path (PAIRWISE_ALIGNER_CLONE_DIR NAMES build_system/pairwise_aligner-config.cmake HINTS "${CMAKE_CURRENT_LIST_DIR}/..")
find_path (PAIRWISE_ALIGNER_INCLUDE_DIR NAMES pairwise_aligner/version.hpp HINTS "${PAIRWISE_ALIGNER_CLONE_DIR}/include")

# extract version from pairwise_aligner/version.hpp header
file(STRINGS "${PAIRWISE_ALIGNER_INCLUDE_DIR}/pairwise_aligner/version.hpp" PAIRWISE_ALIGNER_VERSION_HPP REGEX "#define PAIRWISE_ALIGNER_VERSION_(MAJOR|MINOR|PATCH)")
string(REGEX REPLACE "#define PAIRWISE_ALIGNER_VERSION_(MAJOR|MINOR|PATCH) " "" PACKAGE_VERSION "${PAIRWISE_ALIGNER_VERSION_HPP}")
