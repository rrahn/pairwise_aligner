...
# This file adds version support for `find_package(LIB_TEMPLATE 3.1)`.
...
find_path (LIB_TEMPLATE_CLONE_DIR NAMES build_system/lib_template-config.cmake HINTS "${CMAKE_CURRENT_LIST_DIR}/..")
find_path (LIB_TEMPLATE_INCLUDE_DIR NAMES lib_template/version.hpp HINTS "${LIB_TEMPLATE_CLONE_DIR}/include")

# extract version from lib_template/version.hpp header
file(STRINGS "${LIB_TEMPLATE_INCLUDE_DIR}/lib_template/version.hpp" LIB_TEMPLATE_VERSION_HPP REGEX "#define LIB_TEMPLATE_VERSION_(MAJOR|MINOR|PATCH)")
string(REGEX REPLACE "#define LIB_TEMPLATE_VERSION_(MAJOR|MINOR|PATCH) " "" PACKAGE_VERSION "${LIB_TEMPLATE_VERSION_HPP}")
