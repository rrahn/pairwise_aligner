...
/*!\file
 * \brief Provides seqan::pairwise_aligner::cfg::score_model_matrix_simd_saturated_1xN.
...
namespace cfg
{
namespace _score_model_matrix_simd_saturated_1xN
{
...
struct traits
{
    ...
    using score_model_type = score_model_matrix_simd_1xN<score_type, dimension>;
...
struct _fn
{
                                    ...
                                    substitution_matrix) const
    {
        ...
        using traits_t = _score_model_matrix_simd_saturated_1xN::traits<substitution_matrix_t>;
        using rule_t = _score_model_matrix_simd_saturated_1xN::rule<predecessor_t, traits_t>;
...
inline constexpr _score_model_matrix_simd_saturated_1xN::_cpo::_fn score_model_matrix_simd_saturated_1xN{};
