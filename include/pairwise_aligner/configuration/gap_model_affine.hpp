...
struct traits
{
    ...
    constexpr std::pair<gap_model_type, initialisation_rule> create() const
    {
        return std::pair{gap_model_type{_gap_open_score, _gap_extension_score}, initialisation_rule{}};
    }
};
